...
@SET VS_CMD="%VS140COMNTOOLS%..\IDE\devenv.exe"
...
:VS08BUILD
%VS_CMD% sigar.sln /Clean
%VS_CMD% sigar.sln /Build Release
%VS_CMD% sigar.sln /Build Release /project RUN_TESTS
%VS_CMD% sigar.sln /Build Release /project PACKAGE
%VS_CMD% sigar.sln /Build Release /project INSTALL
